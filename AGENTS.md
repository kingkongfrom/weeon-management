...
| `docs/auth.md` | **Ops staff vs school admin** — Settings administrators, branded invite, password reset. Never use `profiles` for Weeon Ops access |
...
1. **You are in `weeon-management` — the internal ops console.** Do **not**
   ...
   **Weeon Ops staff ≠ tenant school admins.** Settings → Administrators is
