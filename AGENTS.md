...
| `README.md` | Scaffold status, run/verify commands, project structure |
...
- Platform client: `lib/supabase/platform.ts`. Public/anon client:
  `lib/supabase/client.ts`. Domain models: `lib/domain.ts`.
